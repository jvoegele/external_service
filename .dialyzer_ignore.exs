[
  ...
  # unreachable (the retry loop now lives in `call_with_retry/4`, which
  # `call_with_retry/3` delegates to once it has the service state). They ARE
  # reached at runtime — see the "retries are exhausted"
